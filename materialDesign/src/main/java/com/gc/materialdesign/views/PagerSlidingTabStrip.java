...
public class PagerSlidingTabStrip extends HorizontalScrollView {
 ...
 //   private int dividerColor = 0x1A000000;
    ...
    private int tabSelectedTextColor = getResources().getColor(android.R.color.white);
   private int tabBgColor = getResources().getColor(android.R.color.white);
    private int tabSelectedBgColor = getResources().getColor(android.R.color.white);
...
// pre-ICS-build
    ...
    public void setSelectedTabBgColor(int color){
        tabSelectedBgColor = color;
    }
